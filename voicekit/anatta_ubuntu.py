...
def speakThai(text):
    ...
    os.system('mpg123 -d 2 -f 4000 ' + stext)
...
try:
    ...
    with sd.RawInputStream(samplerate=args.samplerate, blocksize = 8000, device=args.device, dtype='int16',
            ...
            # get_help()
            os.system('espeak -s 130 -a 20 -v "english-us" "Nothing is worth insisting on"')
            os.system('mpg123 -q -f 3000 ../thaivoices/hello.mp3')
                        ...
                        if not focus:
                            ...
                            if "what" in words and "time" in words:
                                ...
                                if "loop" in words:
                                    ...
                                    proc = subprocess.Popen(["mpg123","-f","4000","-C","--loop","-1","../datath/chanting/anapanasati-cut.mp3"], stdin=master)
                                    motion_detect()
                                else:
                                    subprocess.run(["mpg123","-f","4000","../datath/chanting/anapanasati-cut.mp3"])

                            elif "nature" in words and "truth" in words and "chanting" in words:
                                killPlayer()
                                speak("Thai Dhamma Ni yam chanting")
                                proc = subprocess.Popen(["mpg123","-f","4000","-C","--loop","-1","../datath/chanting/dhammaniyam.mp3"], stdin=master)
                                motion_detect()
                                ...
                                proc = subprocess.Popen(["mpg123","-f","4000","-C","--loop","-1","../datath/chanting/ituppajjayata.mp3"], stdin=master)
                                motion_detect()

                            elif "eight" in words and "fold" in words and "path" in words and "thai" in words:
                                killPlayer()   
                                speak("Thai Noble 8 fold path chanting")
                                proc = subprocess.Popen(["mpg123","-f","4000","-C","--loop","-1","../datath/chanting/8.mp3"], stdin=master)
                                motion_detect()
                                ...
                                if have_internet():
                                    ...
                                    proc = subprocess.Popen(["mpg123","-f","4000","-q","http://199.180.72.2:9097/lamrim"])
                                    motion_detect()
                                else:
                                ...
                                proc = subprocess.Popen(["mpg123","-f","2000","-q","--loop","-1","../thaivoices/buddho0.mp3"])
                                motion_detect()
                                ...
                                proc = subprocess.Popen(["mpg123","-d","3","-f","2000","-q","--loop","-1","../thaivoices/buddho.mp3"])
                                motion_detect()
                                ...
                                os.system("mpg123 -q -f 4000 "+text)
                                ...
                                while True:
                                    ...
                                    if time.time() > timeout:
                                        ...
                                        os.system('mpg123 -f 4000 ' + th_right)
                                        time.sleep(1)
                                        os.system('mpg123 -f 4000 ' + th_left)
                                        time.sleep(1)

                                        os.system('mpg123 -f 4000 ' + en_right)
                                        time.sleep(1)
                                        os.system('mpg123 -f 4000 ' + en_left)
                                        time.sleep(1)
                                del th_left
                                del th_right
                                del en_left
                                ...
                                while True:
                                    ...
                                    if time.time() > timeout:
                                        ...
                                        os.system('mpg123 -f 4000 ' + th_stage)
                                        time.sleep(1)
                                        os.system('mpg123 -f 4000 ' + en_stage)
                                        time.sleep(1)
                                ...
                                killPlayer()    
                                os.system("mpg123 -f 2000 ../datath/sutta/moggallana.mp3")
                                proc = subprocess.Popen(["mpg123","-f","2000","-C","-Z","--list","sutra.txt"], stdin=master)
                                motion_detect() 
...
# TEST VERSION , use web camera as a button
